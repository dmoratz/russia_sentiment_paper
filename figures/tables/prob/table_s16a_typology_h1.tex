\begin{table}[t]
\caption{\label{tab:s16a}Typology Robustness — H1 — Effect of the invasion on sentiment. Same specification under each time-assignment variant}
...
\midrule\addlinespace[2.5pt]
Estimate & -0.217*** & -0.267*** & -0.156*** \\ 
Std. Error & (0.036) & (0.034) & (0.041) \\ 
Bootstrap p & — & — & — \\ 
N & 45,366 & 68,973 & 31,603 \\ 
Clusters & — & — & — \\ 
\bottomrule
\end{tabular*}
