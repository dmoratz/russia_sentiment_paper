\begin{table}[t]
\caption{\label{tab:s10loo}H3a Leave-One-Out Country Robustness (Probabilistic Time)}
...
specified country. Bandwidth is recalculated for each subset. Coefficient
shown is for the Russia-aligned x treatment interaction term. Standard errors
clustered at source domain level.\\
\end{minipage}
\end{table}
